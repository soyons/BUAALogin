...
class LoginManager:
	def __init__(self,
		url_login_page = "https://gw.buaa.edu.cn/srun_portal_pc?ac_id=1&theme=buaa",
		url_get_challenge_api = "http://gw.buaa.edu.cn/cgi-bin/get_challenge",
		url_login_api = "http://gw.buaa.edu.cn/cgi-bin/srun_portal",
		n = "200",
		vtype = "1",
		acid = "1",
		enc = "srun_bx1"
	...
	def _get_challenge(self):
		...
		params_get_challenge = {
			"callback": "jQuery15815616146", # This value can be any string, but cannot be absent
